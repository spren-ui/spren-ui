...
export { TabsList } from './src/tabs-list';
export { TabTriggerContext, TabsTrigger, type TabsTriggerProps } from './src/tabs-trigger';
export { tabsAnatomy } from './src/tabs.anatomy';
